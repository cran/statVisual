...
can handle missing values by replacing the missing values in the dataset by zero.
...
It looks like *iprcomp* captures the original pattern by replacing missing values with zeros. More thorough investigations are warranted.
